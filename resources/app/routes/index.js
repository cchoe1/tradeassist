...
var GDAXSocketTools = require(__dirname + '/../gdax.js');
var SocketMiddleware = require(__dirname + '/../socket.js');


/* GET home page. */
router.get('/', function(req, res, next) {
	console.log("UHHH OKAY");
  	res.render('../views/pages/index.jade', { title: 'Trade Assist UI' });
  	// res.render('lol');
});

router.get('/trade', function(req, res, next) {
  	res.render('/../views/pages/trade.jade', { title: 'Trade Assist UI' });
});
